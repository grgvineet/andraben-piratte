...
/*
  ...
  bswabe_msk_free(*msk).
*/
void bswabe_setup( bswabe_pub_t** pub, bswabe_msk_t** msk, int parameters_type);
...
/*delegate key*/
bswabe_del_prv_t* bswabe_delegate( bswabe_pub_t* pub, bswabe_msk_t* msk, bswabe_prv_t* prv, char* u_k_c_str, char** attributes, size_t num_attr);
/*
